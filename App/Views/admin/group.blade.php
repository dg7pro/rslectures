...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3 mb-5">
            <div class="col-lg-12">
                <h2>
                    {{$content['name']}}<a href="{{'/course/details?id='.$content['id']}}" target="_blank" class="ml-3"><i class="fas fa-external-link-alt"></i></a>
                </h2>
                ...
                <div>
                    <form method="post" action="/admin/save-group">
