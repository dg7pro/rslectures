...
@section('content')
    ...
    <div class="container mb-5">
        ...
        <p class="mb-2">
            For Cancellations please contact the us via contact us link.</p>
        <p class="mb-2">
            Requests received later than 7 business days prior to the end of the current service
            period will be treated as cancellation of services for the next service period.</p>
