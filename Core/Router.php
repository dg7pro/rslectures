...
class Router
{
    ...
    public function add($route, $params = [])
    {
        // split the route into segments by non-escaped forward slashes -
        // use negative lookbehind to only match forward slashes that aren't escaped with a backslash
